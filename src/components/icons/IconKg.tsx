...
const Icon = (props: IconProps) => {
	...
	return (
		<Svg fill={color} viewBox="0 0 302.033 302.033" width={size} height={size} {...otherProps}>
			<G>
				<Path
					d="M245.1,100.362h-50.988c-9.772,0-17.858-7.141-19.379-16.485c12.939-7.984,21.584-22.287,21.584-38.576
					...
					C193.946,185.056,193.766,188.565,193.766,193.875z"
				/>
				<Path
					d="M174.417,187.126c-7.56,0-12.96,6.39-12.96,16.469c0,8.55,4.32,15.659,12.869,15.659c4.86,0,9.27-3.06,10.979-8.1
					c0.45-1.35,0.63-2.88,0.63-4.229v-7.83c0-1.35-0.09-2.52-0.45-3.6C184.046,190.905,180.177,187.126,174.417,187.126z"
				/>
			</G>
		</Svg>
	);
...
export const IconKg: NamedExoticComponent<IconProps> = memo<IconProps>(themed(Icon));
